...
describe('Test About Gomycode page via Gomycode', () => {
    it('Test for a successful About Gomycode page navigation', () => {
      ...
      cy.get('#label-lastname-d0fe44e4-6740-475d-84a2-38504fa657a4 > :nth-child(1)').type('Juliana');
      cy.get('#label-firstname-d0fe44e4-6740-475d-84a2-38504fa657a4 > :nth-child(1)').type('Onabanjo');
      cy.get('#label-phone-d0fe44e4-6740-475d-84a2-38504fa657a4 > :nth-child(1)').type('09077158759');
      cy.get('#label-email-d0fe44e4-6740-475d-84a2-38504fa657a4 > :nth-child(1)').type('julianaonabanjo4@gmail.com');
